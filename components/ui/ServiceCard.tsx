...
const icons: Record<string, React.ReactNode> = {
  ...
  film: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375V5.625m0 0A2.25 2.25 0 017.5 3.375h9a2.25 2.25 0 012.25 2.25m0 0V18a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18V5.625" />
  ),
  reels: (
...
export function ServiceCard({ title, description, icon }: ServiceCardProps) {
  return (
    <motion.div
      ...
      className="glass card-glow group h-full rounded-2xl p-6 transition-all duration-400"
    >
